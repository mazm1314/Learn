...
<head>
    ...
    <script type="text/javascript">
            ...
            $table.bootstrapTable({
                ...
                responseHandler: function (data) {
                    ...
                    for(var i=0;i<data.list.length;i++){
                        ...
                        if(data.flag=="ls"){
                            approve = '<a href="javascript:;" onclick="answerComment(' + item.id + ')">答复</a>　';
                        }else{
                            approve = '<a href="javascript:;" onclick="deleteComment(' + item.id + ')">删除</a>　';
                        }
        ...
        function deleteComment(id){
            $.ajax({
                url:"./comment/deleteComment.do?commentId="+id,
                async: false,
                type:"get",
                dataType:"text",
        ...
        function answerComment(id) {
            window.open("./comment/toAnswerComment?commentId="+id,"_blank","width=600,height=400,top=100px,left=100px");
        }

        function  newComment() {
            window.open("./comment/toNewComment","_blank","width=600,height=500,top=100px,left=150px");
        }
        ...
        <div class="col-sm-12">
            ...
            <div class="ibox float-e-margins">
                ...
                <div id="operateTools" class="ibox-tools" style="float: left;margin:12px 0px 2px 0px;">
                        <button class="btn btn-primary" onclick="newComment()">新建留言</button>
                </div>
