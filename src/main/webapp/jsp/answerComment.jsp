...
<body class="gray-bg">
<input type="hidden" id="commentId" value="<c:out value='${commentId}'/>"/>
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="location clearfix">
        <p class="pull-left"><i class="fa fa-map-marker"></i> 回复留言</p>
    </div>
    <!--location end-->
                ...
                <div class="ibox-content clearfix">
                    <div class="col-sm-10 col-sm-offset-1 mt20">
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-6">
                                <!--
                                <textarea rows="4" cols="5" id="commentContent" class="form-textarea"/>
                                -->
                    ...
                    <div class="col-sm-10 col-sm-offset-1 mt40">
                        ...
                        <div class="col-sm-6">
                            <button class="btn btn-primary" type="button" onClick="answerNewComment();">确定</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function answerNewComment(){
        ...
        $.ajax({
            url:"./answerComment?commentId="+commentId+"&commentContent="+commentContent,
            async: false,
            type:"get",
            dataType:"text",
